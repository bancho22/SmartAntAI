...
//    public static final String PASS = "pass";
    ...
    public Domain generateDomain() {
        ...
        Attribute health = new Attribute(antWarsDomain, ATT_HEALTH, Attribute.AttributeType.REAL);
        health.setLims(0., 1.);
        Attribute foodload = new Attribute(antWarsDomain, ATT_FOODLOAD, Attribute.AttributeType.INT);
        foodload.setLims(0, 30);
        Attribute type = new Attribute(antWarsDomain, ATT_TYPE, Attribute.AttributeType.DISC);
        ...
        Attribute carryingSoil = new Attribute(antWarsDomain, ATT_CARRYING_SOIL, Attribute.AttributeType.BOOLEAN);
        Attribute standingOnFood = new Attribute(antWarsDomain, ATT_STANDING_ON_FOOD, Attribute.AttributeType.BOOLEAN);
        Attribute facingEnemy = new Attribute(antWarsDomain, ATT_FACING_ENEMY, Attribute.AttributeType.BOOLEAN);
        Attribute facingFood = new Attribute(antWarsDomain, ATT_FACING_FOOD, Attribute.AttributeType.BOOLEAN);
